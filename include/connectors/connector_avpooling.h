...
class AvPoolingConnector : public Connector<TElem>
{
    ...
    AvPoolingConnector(size_t pool_width, size_t pool_height)
...
template<class TElem>
NodeShPtr<TElem> AveragePooling(const NodeShPtr<TElem>& node, size_t pool_height, size_t pool_width)
{
    auto conn = Connector<TElem>::template create<AvPoolingConnector>(pool_height, pool_width);
    {
