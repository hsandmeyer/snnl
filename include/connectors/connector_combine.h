...
struct CalcAdd {
    ...
    static TElem forward(TElem& input_1, TElem input_2)
    {
...
template <class TElem>
NodeShPtr<TElem> Add(const NodeShPtr<TElem>& node_1,
                     const NodeShPtr<TElem>& node_2)
{
...
template <class TElem>
NodeShPtr<TElem> Subtract(const NodeShPtr<TElem>& node_1,
                          const NodeShPtr<TElem>& node_2)
{
...
template <class TElem>
NodeShPtr<TElem> Mult(const NodeShPtr<TElem>& node_1,
                      const NodeShPtr<TElem>& node_2)
{
...
struct CalcDivide {
    ...
    static std::tuple<TElem, TElem> backward(TElem& input_1, TElem& input_2)
    {
        return std::tuple<TElem, TElem>(1.0 / input_2,
                                        -input_1 / (input_2 * input_2));
    }
};
...
template <class TElem>
NodeShPtr<TElem> Divide(const NodeShPtr<TElem>& node_1,
                        const NodeShPtr<TElem>& node_2)
{
